...
This short guide shows how to **set the output folder one time** before you launch Streamlit. When you do this, every dashboard page will already know where your saved results live—so you do **not** have to retype the output path on each page.
...
## Option B: Pass the output folder as a launch argument
...
Just change the `Output folder` field on any page, or update the environment variable and relaunch Streamlit.
