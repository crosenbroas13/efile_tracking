...
def build_parser() -> argparse.ArgumentParser:
    ...
    probe_run.add_argument("--dpi", type=int, default=72, help="Rendering DPI for black-page check")
    ...
    probe_run.add_argument("--mostly-black", type=float, default=0.90, help="Black pixel ratio threshold")
    ...
    probe_run.add_argument("--mostly-black-adapt", type=float, default=0.90, help="Adaptive ratio threshold")
    ...
    probe_run.add_argument("--skip-black-check", action="store_true", help="Skip black-page evaluation")
